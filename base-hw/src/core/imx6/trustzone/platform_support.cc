...
Native_region * Platform::_mmio_regions(unsigned const i)
{
	static Native_region _regions[] =
	{
		...
		{ Board::TZASC_1_MMIO_BASE, Board::TZASC_1_MMIO_SIZE }, /* TZ address space controller 1 */
		{ Board::TZASC_2_MMIO_BASE, Board::TZASC_2_MMIO_SIZE }, /* TZ address space controller 2 */
		{ Board::RAM1_BASE, Board::RAM1_SIZE } /* non secure RAM */
	};
	return i < sizeof(_regions)/sizeof(_regions[0]) ? &_regions[i] : 0;
}
